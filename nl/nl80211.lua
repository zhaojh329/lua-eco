...
--
-- @function ftype_name
-- @tparam integer typ Frame type (one of `FTYPE_*`).
-- @tparam integer subtype Frame subtype (one of `STYPE_*`).
...
-- @tparam integer iftype Interface type (`IFTYPE_*`).
-- @treturn string name
...
--
-- @function width_name
-- @tparam integer width Channel width (`CHAN_WIDTH_*`).
-- @treturn string name
...
-- @tparam integer typ Channel type (`CHAN_*`).
-- @treturn string name
...
-- @tparam integer freq Frequency in MHz.
-- @treturn integer channel Channel number, or 0 if unknown.
...
-- @function get_noise
-- @tparam string ifname Interface name.
-- @treturn integer noise Noise in dBm (0 if not available).
-- @treturn[2] nil On failure.
-- @treturn[2] string Error message.
...
-- @tparam string|int phy PHY name or index.
-- @treturn integer features Bitmask.
-- @treturn[2] nil On failure.
-- @treturn[2] string Error message.
