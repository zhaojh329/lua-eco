 ...
 * @tparam integer offset Byte offset within the message payload where attributes start.
 * @treturn table attrs
 * @treturn[2] nil On failure.
 * @treturn[2] string Error message.
 */
 ...
 * @tparam integer type Attribute type.
 ...
 *
 * @function nlmsg
 * @tparam integer type Netlink message type.
 * @tparam integer flags Netlink flags bitmask.
