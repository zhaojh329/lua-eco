...
--
-- @function file:lseek
-- @tparam integer offset Offset.
-- @tparam integer where One of `file.SEEK_SET`, `file.SEEK_CUR`, `file.SEEK_END`.
-- @treturn integer New offset on success.
-- @treturn[2] nil On failure.
-- @treturn[2] string Error message.
...
-- @treturn integer Watch descriptor (`wd`).
-- @treturn[2] nil On failure.
-- @treturn[2] string Error message.
-- @usage
-- local w = assert(file.inotify())
...
-- @tparam integer wd Watch descriptor returned by @{inotify:add}.
-- @treturn boolean true On success.
-- @treturn[2] nil On failure.
-- @treturn[2] string Error message.
