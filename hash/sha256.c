 ...
 * The digest is returned as raw binary bytes (32 bytes).
 *
 ...
 * @treturn string Raw 32-byte digest.
 */
...
{
    struct sha256_ctx *ctx = lua_newuserdatauv(L, sizeof(struct sha256_ctx), 0);
